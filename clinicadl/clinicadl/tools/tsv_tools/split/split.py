...
from clinicadl.tools.tsv_tools.tsv_utils import (
    complementary_list,
    extract_baseline,
    chi2,
    category_conversion,
    ...
    remove_sub_labels)
from clinicadl.tools.deep_learning.iotools import return_logger, commandline_to_json
...
def split_diagnoses(formatted_data_path, n_test=100, subset_name="test", MCI_sub_categories=True,
                    ...
                    ignore_demographics=False, train_with_cn=False, verbose=0):
    """
    ...
    for diagnosis_df_path in diagnosis_df_paths:
        ...
        if n_test > 0:
            if train_with_cn and diagnosis!='CN':
                baseline_df = extract_baseline(diagnosis_df, diagnosis)
